...
assert.match(historyIndex, /updates\.push/);
...
// Atomic coordinator contract: all staged files become visible together in the
// in-memory implementation, and a merge failure leaves every file untouched.
...
console.log("market-data adaptive atomic history index throughput contract passed");
