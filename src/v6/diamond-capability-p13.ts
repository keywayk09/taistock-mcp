...
const SUPPLY_CHAIN_CAPABILITY = Object.freeze({
  ...
  notes: "P13/P13b entity-first graph + immutable D1/R2 archive are active. Formal research eligibility remains dataset-specific and requires time-safe evidence plus verified/corroborated edges with primary-source support. Archive is append-only, human-gated, hash-revalidated on read, and never writes OHLC.",
});
...
export function getDiamondToolRegistryP13() {
  ...
  return {
    ...
    supply_chain_graph: {
      ...
      data_population: "VERSIONED_ARCHIVE",
  ...
  return {
    ...
    supply_chain_intelligence: {
      ...
      tools: [
        ...
        "archive_supply_chain_snapshot","find_supply_chain_datasets","get_archived_supply_chain_snapshot","query_archived_supply_chain",
      ],
