...
export const TW_CHIP_INTELLIGENCE_REGISTRY = Object.freeze({
  ...
  registry_version: "tw-chip-intelligence/v1.0.0-prototype",
  ...
  sources: Object.freeze([
    ...
    },
    {
      ...
      status: "EXPERIMENTAL",
      source_name: "MoneyDJ broker branch public page",
      url_templates: ["https://www.moneydj.com/Z/ZG/ZGB/ZGB0/ZGB0.djhtm?a={BROKER_CODE}&b={BRANCH_CODE}"],
      completeness: "RANKED_ONLY",
      source_date_verification: true,
      bulk_collection_allowed: false,
      terms_review_required: true,
      notes: "Discovery/confirmation source only until pagination/full-universe behavior and automation terms are verified. Do not represent ranked output as complete branch inventory.",
    },
    {
      id: "warrant_source_pending_verification",
      capability: "warrant",
      market: "both",
      tier: "UNVERIFIED",
      status: "PLANNED_FAIL_CLOSED",
      source_name: "Warrant source not yet frozen",
      url_templates: [],
      completeness: "UNKNOWN",
      source_date_verification: false,
      bulk_collection_allowed: false,
      terms_review_required: true,
      notes: "Must verify official TWSE/TPEx source contract and dealer-hedging interpretation before production use.",
    },
    {
      ...
      tier: "UNVERIFIED",
      status: "PLANNED_FAIL_CLOSED",
      source_name: "Maintenance-ratio source not yet frozen",
      url_templates: [],
      completeness: "UNKNOWN",
      source_date_verification: false,
      bulk_collection_allowed: false,
      terms_review_required: true,
      notes: "Do not infer account-level maintenance ratio from market aggregates. Freeze a reliable public contract before enabling.",
    },
