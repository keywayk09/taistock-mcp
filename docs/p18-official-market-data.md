...
- D1 `tw_market_data_snapshot_index`：索引、日期、來源、hash、readiness。
- R2 `tw-market-data/v1/...`：immutable payload。
- 相同內容 hash 為 idempotent；後續官方修訂以新 hash 成為新 snapshot，不覆蓋歷史 payload。
